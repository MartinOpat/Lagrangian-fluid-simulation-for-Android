...
if [ "x$DOAUTOTOOL" = "xTRUE" ]; then
    ...
    if [ "x$DOACTION" = "xbuild" ]; then
        ...
        LIBS="-lhdf5_hl -lhdf5 -lm -lz " CFLAGS="-I/home/martin/Android/Sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include" LDFLAGS="-L/home/martin/Android/Sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/lib" ./configure --prefix=/home/martin/Android/Sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr $STATIC_BUILD $SHARED_BUILD
        LIBS="-lhdf5_hl -lhdf5 -lm -lz " make
        LIBS="-lhdf5_hl -lhdf5 -lm -lz " make check
    fi

...
Java_com_example_lagrangianfluidsimulation_MainActivity_onSurfaceCreatedNative(JNIEnv *env, jobject obj) {
    // Setup the VTK components
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_lagrangianfluidsimulation_MainActivity_onDrawFrameNative(JNIEnv *env, jobject obj) {
    // This would trigger the render call for VTK
    vtkGenericOpenGLRenderWindow::New()->Render();
}

extern "C" JNIEXPORT void JNICALL
Java_com_example_lagrangianfluidsimulation_MainActivity_onSurfaceChangedNative(JNIEnv *env, jobject obj, jint width, jint height) {
    // Handle resizing if necessary
    vtkGenericOpenGLRenderWindow::New()->SetSize(width, height);
}
